...
generation step. We compare the approximation made to accelerate 
visualisation with the ground truth result obtained at level $l_0$.
We also compare it with the hierarchical algorithm.
The results are presented table \ref{tab:full-res-stat}, and illustrated
...
\begin{figure}
  \begin{center}
    ...
    {\includegraphics[height=2.0cm]{figs/EG_dragon_normal_zoom}}
    {\includegraphics[height=2.0cm]{figs/EG_dragon_dir_min_zoom}}
    {\includegraphics[height=2.0cm]{figs/EG_dragon_dir_max_zoom}}
    {\includegraphics[height=2.0cm]{figs/snow_I08iso_233_r20_l0_m3}}\\
