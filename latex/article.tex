...
\begin{figure}
  \begin{center}
    ...
    {\includegraphics[height=2.5cm]{figs/Octa_dir_min_zoom}}
    {\includegraphics[height=2.5cm]{figs/Octa_dir_max_zoom}}\\
...
shows the mean curvature estimation in real-time on a dynamic object.

We compare the approximation made to accelerate
