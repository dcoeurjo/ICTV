...
results can be found in \cite{ChapterIICurvature}.%%% Changer avec le chapitre de Jaco à un moment
...
\end{figure}
 ...
 \begin{figure}[h!]
   \vspace{-0.35cm}
   \begin{center}
   	 {\includegraphics[width=0.45\textwidth]{figs/snow_r10}}
     {\includegraphics[width=0.5\textwidth]{figs/snow2_r10}}
     {\includegraphics[width=0.6\textwidth]{figs/xyzrgb_dragon-510_R8_mean}}
   \end{center}
   \caption{\emph{First row}: Mean curvature estimation on Snow Microstructures with a digital domain of $233^3$ and a radius of 10. 
   (left) Full snow object (right) exploration within the object
  \emph{Second row:} Mean curvature estimation on XYZ Dragon with a digital domain of $510^3$ and a radius of 8.}
   \label{fig:adaptive}
   \vspace{-0.35cm}
 \end{figure}
