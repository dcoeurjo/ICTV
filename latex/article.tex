...
of the domain and object on which an efficient adaptive triangulation
...
\caption{Morton codes associated to cells of a linear quatree. Each
  children cell morton code is obtained by adding a suffix to its
  parent code \emph{(left)}. The adpative representation consists of
  quadtree cells whose depth is view point dependent \emph{(right)}.}
