...
%
  ...
  With a regular grid, the curvature computation refines at every frame until it reaches the ground truth result.
  We measured three datasets, OctaFlower (digital domain of $130^3$ ), snow micro structures($233^3$) and the XYZ Dragon ($510^3$)}
  \label{fig:timings}
\end{figure}
...
We measured those timings using the regular and the hierarchical algorithm. The results are presented
