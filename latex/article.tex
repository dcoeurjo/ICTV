...
\begin{figure}
  ...
  \end{center}
  \caption{Illustration of mean curvature computation on an OctaFlower using mipmap approximation of different levels : $l_4$, $l_3$, $l_2$, $l_1$ and $l_0$ (\ie no approximation).
  %
...
%      \end{axis}
      ...
      \begin{axis}[
        ...
        \addplot+[ybar] plot coordinates {(Octa-R8,17.283000) (Octa-R16,18.458000)
          (Snow-R10,9.831000) (Snow-R20,9.653000)  (xxx-R1,1) (xxx-R2,1)};
        %l4
        \addplot+[ybar] plot coordinates {(Octa-R8,1) (Octa-R16,2.509000)
          (Snow-R10,6.085000) (Snow-R20,9.445000)  (xxx-R1,1) (xxx-R2,1)};
        %l3
        \addplot+[ybar] plot coordinates {(Octa-R8,2.527000) (Octa-R16,4.159000)
          (Snow-R10,10.629000) (Snow-R20,11.542000) (xxx-R1,1) (xxx-R2,1)};
        %l2
        \addplot+[ybar] plot coordinates {(Octa-R8,3.783000) (Octa-R16,9.006000)
          (Snow-R10,13.777000) (Snow-R20,37.700000) (xxx-R1,1) (xxx-R2,1)};
        %l1
        \addplot+[ybar] plot coordinates {(Octa-R8, 11.004000) (Octa-R16,38.687000)
          (Snow-R10,39.627000) (Snow-R20,217.954000) (xxx-R1,1) (xxx-R2,1)};
        %l0
        \addplot+[ybar] plot coordinates {(Octa-R8, 37.273000) (Octa-R16,244.353000)
          (Snow-R10,236.194000) (Snow-R20,1655.680000) (xxx-R1,1) (xxx-R2,1)};
        %\legend{\strut Geometry, \strut Curvature, \strut xx, \strut xx}
      \end{axis}
	  \end{tikzpicture}
      ...
      \begin{axis}[
        ...
        \addplot+[ybar] plot coordinates {(Octa-R8,17.283000) (Octa-R16,17.183000)
          (Snow-R10,9.383000) (Snow-R20,9.767000)  (xxx-R1,1) (xxx-R2,1)};
        %Hierarchical measurement
        \addplot+[ybar] plot coordinates {(Octa-R8,18.095000) (Octa-R16,64.186000)
          (Snow-R10,96.747000) (Snow-R20,364.547000)  (xxx-R1,1) (xxx-R2,1)};
        %\legend{\strut Geometry, \strut Curvature, \strut xx, \strut xx}
      \end{axis}
