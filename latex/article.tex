...
\end{figure}
 ...
 \begin{figure}[h!]
   ...
   \end{center}
   \caption{\emph{Left column}: Mean curvature, first and second principal directions and normales estimation on Snow Microstructures with a digital domain of $233^3$ and a radius of 8. 
  \emph{Right column:} Mean curvature, first and second principal directions and normales estimantion on XYZ Dragon with a digital domain of $510^3$ and a radius of 8.}
   \label{fig:adaptive}
   \vspace{-0.35cm}
 \end{figure}
