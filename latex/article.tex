...
\vspace{0.2cm} \color{blue} In this paper, we first present the
previous works on curvature tensor estimation. Then, we propose na
...
(setting $R\EqDef kh^\frac{1}{3}$ for some $k\in\R$).
\normalcolor
%
