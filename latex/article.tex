...
only $300$ms while the $l_0$ visualization takes more than $4$ seconds.
...
the visualized value, the curvature radius, \cdots). It is also clear on those
...
$l_0$ level, whereas using the hierarchical algorithm, it only needs $700$ms.
