...
objects with volumetric integral information have the multigrid convergence
...
estimation if we consider the full resolution geometry, due the the huge amount of data to process. By computing a
