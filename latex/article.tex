...
\begin{figure}
  \vspace{-0.35cm}
  \begin{center}
    \raisebox{60pt}{\includegraphics[width=3.7cm]{figs/approx-naive}}
    \hfill
    \raisebox{60pt}{\includegraphics[width=3.7cm]{figs/approx-hierarchical}}
    \hfill
    \includegraphics[width=3.7cm]{figs/approx-dynamic}
  \end{center}
  \vspace{-0.35cm}
  \caption{\txtblue{
