...
To implement the integration on $B_R(x)\cap\Shape$
...
\begin{figure}
  \begin{center}
    \subfigure[]{\includegraphics[width=5cm]{figs/approx1}}
    \subfigure[]{\includegraphics[width=5cm]{figs/approx-reg-1}}
    \subfigure[]{\includegraphics[width=5cm]{figs/approx-reg-2}}
