...
enum {PROGRAM_LTREE_LOD, PROGRAM_LTREE_CULL, PROGRAM_CELL_DRAW, PROGRAM_REGULAR_DRAW, PROGRAM_TRANSITION_DRAW, 
            PROGRAM_FRAMEBUFFER_BLIT, PROGRAM_SKYBOX, 
			PROGRAM_SHADING, PROGRAM_GTCURV, PROGRAM_APPROXCURV, PROGRAM_HIERARCHCURV, PROGRAM_GAUSSCURV,
...
enum {VERTEX_ARRAY_EMPTY, VERTEX_ARRAY_LTREE_UPDATE1, VERTEX_ARRAY_LTREE_UPDATE2, 
        ...
        VERTEX_ARRAY_SHADING, VERTEX_ARRAY_SHADING_TR, 
...
enum {BUFFER_TRANSFORMS, BUFFER_FRUSTUM, 
		...
		BUFFER_VERTEX_CUBE, BUFFER_INDEX_CUBE, BUFFER_TRIANGULATION, BUFFER_TRIANGULATION_TR, 
...
enum {
	...
	LOCATION_GAUSSCURV_SIZE,
	LOCATION_GAUSSCURV_DENSITY,
	LOCATION_GAUSSCURV_VIEWPORT,
	LOCATION_GAUSSCURV_TAN_FOVY,
	LOCATION_GAUSSCURV_SCALE,
	LOCATION_GAUSSCURV_WIREFRAME,
	LOCATION_GAUSSCURV_CAMERA,
	LOCATION_GAUSSCURV_CURVRADIUS,
	LOCATION_GAUSSCURV_CURVMIN,
	LOCATION_GAUSSCURV_CURVMAX,
	LOCATION_GAUSSCURV_GROUNDTRUTH,
	LOCATION_GAUSSCURV_SIZETEX,
	LOCATION_GAUSSCURV_XYZTEX,
	LOCATION_GAUSSCURV_XY_YZ_XZ_TEX,
